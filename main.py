...
<p class="d-inline-flex gap-1" style="justify-content:space-between">
...
Наличный или безналичный расчет  </div>
</div>
                <div class="collapse" id="collapseExample2">
  <div class="card card-body">
Самовывоз или курьер  </div>
</div>
                <div class="collapse" id="collapseExample3">
  <div class="card card-body">
Заводская гарантия 1 год  </div>
</div>
            </div>
        </main>
    </div>
